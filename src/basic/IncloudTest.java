...
@WebServlet(name = "forward", urlPatterns = { "/include.do" })
public class IncloudTest extends HttpServlet {
	protected void doGet(HttpServletRequest request, 
		...
		System.out.println("includ연습 - includ서블릿 실행중");
		out.print("<h1>요청재지정 연습- includ</h1>");
		...
		//서블릿이 요청되고 response됮 않은 상태로 다시 jsp가 요청되는 것이므로 현재
